  ...
  <div class="ma-2">
    ...
    <div class="text-body-1">
      <p>
        ...
        receiving content specifically for you and what makes you unique. If you
        need more support than this, I'm happy to help. Simply book a call with
        me.
      </p>
      <p>
      ...
      <div v-if="findJobThroughNetwork">
        <div v-if="hasJobLinedUp">
          ...
          <div class="text-body1 my-6">
            You're feeling lots of resistence in your current job and you've got
            another job lined up. So what are you waiting for?
          </div>
        </div>
        <div v-else>
          ...
          <div class="text-body-1 my-6">
            ...
            important not to leave until you have a new one lined up. Your huge
            network is an asset to finding that new job which fits you. Talk to
            all of these people and find a new opportunity which is correct for
            you ... and then pull the trigger.
          </div>
        </div>
      </div>
      <div v-else>
    ...
    <div v-else>
      ...
      <div class="text-body-1 my-6">
        <p>
          ...
          is: what's going wrong? And what changes can you make to feel more in
          the flow? Perhaps a talk with your boss if you have one can align you
          more with what you desire. Or if you're self-employed, maybe working
          with others can be of help.
        </p>
        <p>
